...
app.post("/api/caption", async (req, res) => {
  try {
    ...
    // Robustly extract text from potential schema variations
    const getSafeText = (obj: any, defaultText: string) => {
      if (typeof obj === 'string') return obj;
      if (typeof obj === 'object' && obj !== null && typeof obj.text === 'string') return obj.text;
      return defaultText;
    };
    
    const getSafeTitle = (obj: any, defaultTitle: string) => {
      if (typeof obj === 'object' && obj !== null && typeof obj.title === 'string') return obj.title;
      return defaultTitle;
    };

    const formalText = getSafeText(parsed?.formal, "Professional description generated by VisionCaption AI.");
    const sarcasticText = getSafeText(parsed?.sarcastic, "Witty analysis generated by VisionCaption AI.");
    const techText = getSafeText(parsed?.humorousTech, "Developer humor generated by VisionCaption AI.");
    const humorousText = getSafeText(parsed?.humorous, "General fun caption generated by VisionCaption AI.");
    ...
    const formattedResult = {
      ...
      captions: {
        formal: {
          style: "formal",
          title: getSafeTitle(parsed?.formal, "Professional Description"),
          text: formalText,
        ...
        sarcastic: {
          style: "sarcastic",
          title: getSafeTitle(parsed?.sarcastic, "Witty Analysis"),
          text: sarcasticText,
        ...
        "humorous-tech": {
          style: "humorous-tech",
          title: getSafeTitle(parsed?.humorousTech, "Dev Humor"),
          text: techText,
        ...
        humorous: {
          style: "humorous",
          title: getSafeTitle(parsed?.humorous, "General Fun"),
          text: humorousText,
          wordCount: humorousText.split(/\s+/).filter(Boolean).length,
          charCount: humorousText.length,
        },
      },
    };
...
async function startServer() {
  app.listen(PORT, () => {
    console.log(`Server: VisionCaption AI backend API running on port ${PORT}`);
  });
}
